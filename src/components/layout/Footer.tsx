        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-200 mb-6 text-sm leading-relaxed">
              Catering rumahan premium untuk kantor, event & kebutuhan harian.
              Melayani area Gading Serpong, BSD, dan Jabodetabek.
            </p>
            <div className="flex gap-4">
              <a
                href="https://www.instagram.com/dapursrasa/"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/10 p-2 rounded-full hover:bg-[#D4AF37] transition-colors"
              ...
              <a
                href="https://www.tiktok.com/@dapur.srasa"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/10 p-2 rounded-full hover:bg-[#D4AF37] transition-colors"
                aria-label="TikTok"
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-heading font-semibold text-lg mb-4 text-[#D4AF37]">
              Tautan Cepat
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  href="https://wa.me/62895328596248?text=Halo%20Admin%20Dapur%20Srasa%2C%20saya%20menghubungi%20dari%20Footer%20Website."
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  href="mailto:dapursrasa@gmail.com"
                  className="text-gray-200 hover:text-white text-sm transition-colors"
                >
