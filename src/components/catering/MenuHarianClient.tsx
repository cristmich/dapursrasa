...
const varianMenu = [
  {
    ...
    menu: [
      ...
      {
        nama: "Ayam Goreng Asin",
        lauk: ["Tumis Bayam", "Tahu & Tempe Goreng + Lalapan"],
      },
      {
        nama: "Ayam Goreng Manis",
        lauk: ["Tumis Bayam", "Tempe & Tahu Goreng + Lalapan"],
      },
    ],
  },
  {
    ...
    menu: [
      ...
      {
        nama: "Dori Goreng Tepung Sambal Matah",
        lauk: ["Cah Pakcoy", "Bihun Goreng"],
      },
  ...
  },
  {
    ...
    menu: [
      ...
      {
        nama: "Udang Goreng Tepung Sambal Matah",
        lauk: ["Jamur Putih", "Cah Kailan"],
      },
    ],
  },
];
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-extrabold text-[#1a1a1a] mb-4 leading-tight">
            Varian Menu{" "}
            <span className="text-[#005926]">Catering Mingguan</span>
          </h2>
          <p className="text-gray-500 leading-relaxed mb-6">
            Pilih dari 17 varian lauk utama. Menu dapat dikombinasikan setiap
            hari agar tidak bosan dan selalu variatif.
          </p>
          ...
          {varianMenu.map((kategori, ki) => (
            <div key={ki}>
              ...
              <div className="flex items-center gap-3 mb-5">
                <span
                  className={`text-sm font-bold px-3 py-1 rounded-full border ${kategori.warna.badge}`}
                >
                  {kategori.kategori}
                </span>
                <div className="flex-1 h-px bg-gray-200" />
                <span className="text-xs text-gray-400">
                  {kategori.menu.length} menu
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                {kategori.menu.map((item, mi) => (
                  ...
                  >
                    {/* Color accent bar */}
                    <div
                      className={`h-1 w-full bg-gradient-to-r ${kategori.warna.bar}`}
                    />
                      ...
                      <div className="flex-1 space-y-1.5">
                        {item.lauk.map((l, li) => (
                          <div key={li} className="flex items-start gap-1.5">
                            <div
                              className={`w-1.5 h-1.5 rounded-full mt-1.5 shrink-0 ${kategori.warna.dot}`}
                            />
        ...
        <div className="mt-14 max-w-2xl mx-auto text-center">
          <div className="bg-white border border-[#005926]/15 rounded-2xl p-6 mb-6 shadow-sm">
            <p className="text-sm text-gray-500 leading-relaxed">
              Menu dikombinasikan setiap hari oleh tim Dapur Srasa agar selalu
              variatif dan tidak membosankan. Berlangganan mulai{" "}
              <span className="font-bold text-[#005926]">
