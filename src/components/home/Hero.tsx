        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-center py-12 md:py-20">
          ...
          >
            ...
            <h1 className="font-heading text-4xl md:text-5xl xl:text-[3.75rem] font-extrabold leading-[1.15] text-[#1a1a1a]">
              ...
              <span className="relative whitespace-nowrap">
                <span className="relative z-10 text-[#005926]">Premium</span>
                <svg
                  aria-hidden="true"
                  viewBox="0 0 418 42"
              ...
              untuk Kantor, Event & Kebutuhan Harian
            </h1>

            {/* Subtext */}
            <p className="text-lg text-gray-500 leading-relaxed max-w-xl">
              Melayani Catering Mingguan dan Nasi Box dengan menu bervariasi, higienis, dan lezat. Disiapkan dengan bahan segar berkualitas setiap harinya.
            </p>
          ...
          >
            ...
            >
              ...
              <p className="font-bold text-[#005926] text-sm">Jabodetabek</p>
