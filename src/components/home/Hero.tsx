        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-center py-12 md:py-20">
          ...
          >
            ...
            <h1 className="font-heading text-4xl md:text-5xl xl:text-[3.75rem] font-extrabold leading-[1.15] text-[#1a1a1a]">
              ...
              <span className="relative whitespace-nowrap">
                <span className="relative z-10 text-[#005926]">Rp30.000</span>
                <svg
                  aria-hidden="true"
                  viewBox="0 0 418 42"
            ...
            <p className="text-lg text-gray-500 leading-relaxed max-w-xl">
              Catering nasi box berkualitas dengan harga terjangkau. Cocok untuk
              meeting, seminar, gathering, ulang tahun, hingga wedding. Tersedia
              berbagai pilihan menu dengan cita rasa rumahan premium.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-2">
              <Button
                render={
                  <a
                    href="https://wa.me/62895328596248?text=Halo%20Admin%20Dapur%20Srasa%2C%20saya%20tertarik%20dengan%20promo%20Nasi%20Box%20Rp30.000.%20%28Dari%20Beranda%20Utama%29"
                    target="_blank"
          ...
          >
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="flex items-center justify-between bg-white/15 backdrop-blur-md border border-white/20 rounded-2xl px-5 py-3">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-[#D4AF37] font-extrabold text-2xl leading-tight">
                      Rp 35rb
                    </p>
                  </div>
                </div>
            ...
            >
              ...
              <p className="font-bold text-[#005926] text-sm">
            ...
            >
              <div className="flex -space-x-2">
                {["🧑", "👩", "👨"].map((emoji, i) => (
                  <span
                    key={i}
                    className="flex items-center justify-center w-8 h-8 rounded-full bg-[#005926]/10 text-sm ring-2 ring-white"
                  >
                    {emoji}
                  </span>
                ))}
