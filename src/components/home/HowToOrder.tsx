...
const WA_LINK =
  "https://wa.me/62895328596248?text=Halo%20Admin%20Dapur%20Srasa%2C%20saya%20siap%20memesan%20sekarang.%20%28Dari%20Cara%20Pemesanan%29";
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-500 text-lg leading-relaxed">
            Pesan catering berkualitas hanya dalam 6 langkah mudah. Proses
            cepat, admin responsif!
          </p>
        </motion.div>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div
                className={`${step.bg} ${step.color} w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110`}
              >
                <step.icon className="w-6 h-6" />
              </div>

              {/* Text */}
              <h3 className="font-heading font-bold text-base text-[#1a1a1a] mb-2">
                {step.title}
              </h3>
          ...
          <div className="relative bg-gradient-to-br from-[#005926] to-[#003d1a] rounded-3xl overflow-hidden px-8 py-10 text-center shadow-2xl shadow-[#005926]/30">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/70 text-sm md:text-base mb-8 max-w-md mx-auto leading-relaxed">
                Cukup klik tombol di bawah, admin kami siap membantu konsultasi
                menu dan harga dalam hitungan menit!
              </p>
              ...
              <p className="text-white/40 text-xs mt-5">
                Respons dalam &lt; 5 menit · Konsultasi GRATIS · Tidak ada biaya
                tersembunyi
              </p>
            </div>
          </div>
