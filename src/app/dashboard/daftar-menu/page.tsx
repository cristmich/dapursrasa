  ...
  const handleAddMenu = async () => {
    for (let i = 0; i < newMenus.length; i++) {
      if (!newMenus[i].name.trim() || !newMenus[i].price.toString().trim()) {
        return alert(
          `Baris ke-${i + 1} belum lengkap! Pastikan Nama Menu dan Harga terisi.`,
        );
      }
    }
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Kelola daftar menu satuan, lauk pauk, dan hidangan lainnya.
          </p>
        </div>
          ...
          <div className="bg-white w-full max-w-4xl rounded-2xl shadow-xl flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-4">
              <p className="text-sm text-gray-500 mb-4">
                Anda dapat menambahkan lebih dari satu menu sekaligus.
              </p>

              {newMenus.map((menu, index) => (
                <div
                  key={index}
                  className="flex flex-col md:flex-row gap-4 items-start md:items-center bg-gray-50 p-4 rounded-xl border border-gray-100 relative"
                >
                  ...
                  <div className="w-full md:w-32 space-y-1.5">
                    ...
                    <Input
                      ...
                      value={menu.price}
                      onChange={(e) =>
                        handleAddChange(index, "price", e.target.value)
                      }
                    />
                  </div>
                  <div className="w-full md:w-36 space-y-1.5">
                    ...
                    <select
                      value={menu.category}
                      onChange={(e) =>
                        handleAddChange(index, "category", e.target.value)
                      }
              ...
              <Button
                ...
                className="w-full border-dashed border-2 py-6 text-gray-500 hover:bg-gray-50"
              >
                  ...
                  <label className="flex items-center gap-2 cursor-pointer text-sm">
                    <input
                      ...
                      onChange={(e) =>
                        setEditData({
                          ...editData,
                          isActiveNasiBox: e.target.checked,
                        })
                      }
                      className="w-4 h-4 rounded border-gray-300 text-[#005926] focus:ring-[#005926]"
                    />
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500 mt-1">
              {selectedCategory === "Semua"
                ? "Tambahkan item daftar menu pertama Anda."
                  ...
                  >
                    ...
                    <td className="p-4 text-right space-x-2 whitespace-nowrap">
                      <Button
                        ...
                        className="h-8 w-8 text-gray-400 hover:text-[#005926] hover:bg-[#005926]/10 rounded-lg"
                      >
                        <Pencil size={14} />
                      </Button>
                      <Button
