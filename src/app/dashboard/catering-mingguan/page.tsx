      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 font-heading">
            Menu Catering Mingguan
          </h1>
          <p className="text-gray-500 mt-1">
            Kelola paket catering 5 hari (Senin-Jumat) beserta harga per
            Pax-nya.
          </p>
        </div>
        <Button
          onClick={() => router.push("/dashboard/catering-mingguan/form")}
      ...
      <div className="space-y-4">
        {isLoading ? (
          ...
          <div className="p-12 text-center bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500 mt-1">
              Tambahkan paket catering 5 hari pertama Anda.
            </p>
          </div>
        ) : (
                ...
                <div className="p-5 md:p-6 flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-1/3 flex flex-col gap-4">
                    ...
                    <div className="bg-[#005926]/5 rounded-xl p-3 border border-[#005926]/10 mt-auto">
                      <p className="text-xs font-bold text-[#005926] uppercase tracking-wider mb-2">
                        Daftar Harga (5 Hari)
                      </p>
                  ...
                  <div className="md:w-2/3 border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          onClick={() =>
                            router.push(
                              `/dashboard/catering-mingguan/form?id=${pkg.id}`,
                            )
                          }
                          className="h-8 w-8 rounded-full border-gray-200 text-gray-600 hover:text-[#005926]"
                        >
                          <Pencil size={14} />
                        </Button>
                        <Button
                          ...
                          className="h-8 w-8 rounded-full border-gray-200 text-gray-600 hover:text-red-600 hover:bg-red-50"
                        >
                          <Trash2 size={14} />
                        </Button>
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                      {days.map((day) => {
                        const key =
                          day.toLowerCase() as keyof typeof pkg.weeklyMenus;
                        const dayMenus = pkg.weeklyMenus
                          ? pkg.weeklyMenus[key]
                          : [];
                        return (
                          <div key={day} className="bg-gray-50 rounded-lg p-3">
                            <p className="text-xs font-bold text-[#005926] uppercase mb-2">
                              {day}
                            </p>
