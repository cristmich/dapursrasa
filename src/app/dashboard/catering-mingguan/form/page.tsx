...
export default function CateringMingguanForm() {
  ...
  const handleSave = async (e?: React.FormEvent) => {
    ...
    const processMenuString = (str: string) =>
      str
        .split(",")
        .map((s) => s.trim())
        .filter((s) => s !== "");
    ...
    try {
      ...
      alert(
        `Gagal menyimpan paket. Error: ${error?.message || "Unknown error"}`,
      );
    ...
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center gap-4">
        <Button
          variant="outline"
          size="icon"
          onClick={() => router.push("/dashboard/catering-mingguan")}
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Konfigurasi lauk pauk 5 hari dan harga Pax.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="font-semibold text-gray-900 flex items-center gap-2">
                <span className="bg-[#D4AF37]/20 text-[#D4AF37] w-6 h-6 rounded-full flex items-center justify-center text-xs">
                  1
                </span>
                Informasi Utama
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    placeholder="Contoh: Catering Keluarga"
                    value={name}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    placeholder="Contoh: 15 Juli - 19 Juli 2024"
                    value={period}
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-500 mb-2">
                Pisahkan setiap lauk/menu dengan tanda koma (,). Contoh:{" "}
                <em>Nasi Putih, Ayam Bakar Madu, Sayur Asem, Kerupuk</em>
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {days.map((day) => {
                  ...
                  return (
                    <div
                      key={day}
                      className="space-y-2 p-3 bg-gray-50 rounded-xl border border-gray-100"
                    >
                      <label className="text-sm font-semibold text-[#005926]">
                        {day}
                      </label>
                      <textarea
                  ...
                  <div key={index} className="flex items-center gap-3">
                    <div className="w-24">
                      <Input
                        ...
                        value={tier.pax}
                        onChange={(e) =>
                          handlePricingChange(index, "pax", e.target.value)
                        }
                        required
                      />
                    </div>
