      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Kelola hak akses dan peran (role) pengguna di aplikasi Anda.
          </p>
        </div>
        <Button
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAddData({ ...addData, displayName: e.target.value })
                  }
                  className="rounded-md border-input bg-white"
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-4">
                        ...
                        >
                          {(role === "super admin" ||
                            role === "superadmin") && <Shield size={12} />}
                          {role}
                        </span>
                      </td>
                      <td className="p-4 text-right space-x-2 whitespace-nowrap">
                        <Button
                          ...
                          className="text-gray-500 hover:text-[#005926] hover:bg-[#005926]/10 rounded-lg"
                        >
