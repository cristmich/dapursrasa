      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Kelola konten artikel dan informasi terbaru untuk website.
          </p>
        </div>
        <Button
          render={<Link href="/dashboard/artikel/form" />}
      ...
      <div className="space-y-4">
        {isLoading ? (
          ...
          <div className="p-12 text-center bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500 mt-1">
              Tulis artikel pertama Anda untuk pengunjung website.
            </p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="relative h-48 w-full bg-gray-100 overflow-hidden group">
                  ...
                  <div className="absolute top-3 right-3 flex gap-2">
                    <span
                      className={`px-2.5 py-1 text-xs font-bold rounded-lg shadow-sm backdrop-blur-md ${article.status === "Published" ? "bg-green-500/90 text-white" : "bg-yellow-400/90 text-yellow-950"}`}
                    >
                      {article.status}
                    </span>
                  </div>
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <div className="flex items-center justify-end gap-2 pt-4 mt-4 border-t border-gray-100">
                    <Button
                      ...
                      render={
                        <Link
                          href={`/dashboard/artikel/form?id=${article.id}`}
                        />
                      }
                      className="rounded-xl border-gray-200 text-gray-600 hover:text-[#005926]"
                    >
                    ...
                    <Button
                      ...
                      className="rounded-xl border-gray-200 text-gray-600 hover:text-red-600 hover:bg-red-50"
                    >
