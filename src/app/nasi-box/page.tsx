        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Nasi Box Premium <br /> Mulai <span className="text-[#D4AF37]">Rp 30.000</span>
            </h1>
      ...
      <section className="py-20 bg-[#F8F8F8]">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mb-14">
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-[#333333] mb-4">Pilihan Menu Nasi Box</h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center">
            <Button
              render={<a href="https://wa.me/62895328596248?text=Halo%20Admin%20Srasa,%20saya%20mau%20pesan%20Nasi%20Box.%20Boleh%20minta%20info%20lebih%20lanjut%3F" target="_blank" rel="noopener noreferrer" />}
