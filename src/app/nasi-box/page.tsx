...
import { NasiBoxPortofolio } from "@/components/nasi-box/NasiBoxPortofolio";
...
export const metadata: Metadata = {
  ...
  description:
    "Pesan Nasi Box termurah No 1 di BSD, Gading Serpong, Alam Sutera, Tangerang, dan Jakarta. Harga mulai Rp35.000, 100% halal, lezat, dan Gratis Ongkir Jabodetabek.",
  keywords: [
    "nasi box",
    "nasi box murah",
    "nasi box tangerang",
  ...
  openGraph: {
    title: "Nasi Box Termurah di Tangerang & Jakarta | Dapur Srasa",
    description:
      "Pesan Nasi Box termurah No 1 di BSD, Gading Serpong, Alam Sutera, Tangerang, dan Jakarta. Harga mulai Rp35.000, 100% halal.",
  ...
  twitter: {
    ...
    title: "Nasi Box Termurah di Tangerang & Jakarta | Dapur Srasa",
    description:
      "Pesan Nasi Box termurah No 1 di BSD, Gading Serpong, Tangerang & Jakarta. Mulai Rp35.000.",
...
const paketNasiBox = [
  ...
  },
  {
    ...
    menu: [
      "Nasi Putih",
      "Dori Goreng Tepung Sambal Matah",
      "Cah Pakcoy",
      "Bihun Goreng",
      "Free Sambal",
      "Free Kerupuk",
  ...
  },
  {
    ...
    menu: [
      "Nasi Putih",
      "Udang Goreng Tepung Sambal Matah",
      "Jamur Putih",
      "Cah Kailan",
      "Free Sambal",
      "Free Kerupuk",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            hasMenuItem: paketNasiBox.map((paket) => ({
              "@type": "MenuItem",
              name: paket.nama,
              description: paket.menu
                .filter((m) => !m.startsWith("Free") && m !== "Nasi Putih")
                .join(", "),
              offers: {
                "@type": "Offer",
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Nasi Box Premium <br /> Mulai{" "}
              <span className="text-[#D4AF37]">Rp 30.000</span>
            </h1>
            <p className="text-xl text-white/90 mb-10">
              Sajian lezat, kemasan elegan, dan pelayanan profesional untuk
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mb-14">
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-[#333333] mb-4">
              Pilihan Menu Nasi Box
            </h2>
            <p className="text-lg font-medium text-[#005926] mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 max-w-7xl mx-auto">
            {paketNasiBox.map((paket, index) => {
              ...
              const accent = isDaging
                ...
                : isUdang
                  ...
                  : isIkan
                    ...
                    : {
                        bar: "from-[#005926] to-[#D4AF37]",
                        badge: "bg-green-50 text-green-800 border-green-100",
                        label: "🍗 Ayam",
                      };

              // Separate main items from free items
              const mainItems = paket.menu.filter(
                (m) => !m.startsWith("Free") && m !== "Nasi Putih",
              );
              ...
              return (
                <div
                  key={index}
                  className="relative bg-white rounded-2xl border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-300 flex flex-col overflow-hidden group"
                >
                  {/* Top accent bar */}
                  <div
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <span
                          className={`text-xs font-semibold px-2 py-0.5 rounded-full border ${accent.badge} mb-2 inline-block`}
                        >
                          {accent.label}
                        </span>
                        <h3 className="font-heading font-bold text-[#333333] text-lg leading-tight">
                          {paket.nama}
                        </h3>
                      </div>
                      <div className="text-right shrink-0 ml-2">
                        <div className="font-heading font-bold text-[#005926] text-xl">
                          {paket.harga}
                        </div>
                    ...
                    <div className="flex-1 space-y-2 mb-4">
                      ...
                      {mainItems.map((item, i) => (
                        <div key={i} className="flex items-start gap-2">
                          <div
                            className={`w-1.5 h-1.5 rounded-full mt-1.5 shrink-0 bg-gradient-to-br ${accent.bar}`}
                          />
                      ...
                      <div className="flex flex-wrap gap-1.5 pt-1">
                        {freeItems.map((item, i) => (
                          <span
                            key={i}
                            className="text-xs bg-[#005926]/8 text-[#005926] font-medium px-2 py-0.5 rounded-full border border-[#005926]/15"
                          >
                            ✓ {item}
                          </span>
                        ))}
                    ...
                    <Button
                      render={
                        <a
                          href={`https://wa.me/62895328596248?text=Halo%20Admin%20Srasa,%20saya%20mau%20pesan%20Nasi%20Box%20${paket.nama}%20-%20${paket.harga}`}
                          target="_blank"
          ...
          <p className="text-center text-sm text-gray-400 mt-10">
            * Semua menu sudah termasuk Nasi Putih, Free Sambal & Free Kerupuk.
            Minimum order 10 box.
          </p>
        </div>
      </section>
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {kategoriAcara.map((kategori, i) => (
                <span
                  key={i}
                  className="bg-[#F8F8F8] text-gray-700 border border-gray-200 px-6 py-3 rounded-full text-sm font-medium hover:border-[#005926] hover:text-[#005926] transition-colors cursor-default"
                >
                  {kategori}
                </span>
              ))}
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-gray-500 leading-relaxed">
              Kemasan rapi, higienis, dan menarik. Dilengkapi box sekat agar
              makanan tidak bercampur dan tetap fresh saat diterima.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-8">
            <div className="relative rounded-2xl overflow-hidden shadow-md group aspect-[4/3]">
              ...
              <img
                src="/sample-nasi-box-1.jpg"
                alt="Nasi Box Dapur Srasa - Selamat Menikmati"
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-md group aspect-[4/3]">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src="/sample-nasi-box-2.jpg"
                alt="Nasi Box Dapur Srasa - Indonesian Foods Premium"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
              <div className="absolute bottom-4 left-4">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            {[
              ...
              { icon: "🍘", label: "Free Kerupuk", desc: "Sudah termasuk" },
              {
                icon: "🍚",
                label: "Nasi Putih",
                desc: "Porsi pas & mengenyangkan",
              },
            ].map((f, i) => (
              <div
                key={i}
                className="flex items-center gap-3 bg-[#F8F8F8] rounded-xl px-4 py-3 border border-gray-100"
              >
          ...
          <div className="text-center">
            <Button
              render={
                <a
                  href="https://wa.me/62895328596248?text=Halo%20Admin%20Srasa,%20saya%20mau%20pesan%20Nasi%20Box.%20Boleh%20minta%20info%20lebih%20lanjut%3F"
                  target="_blank"
                  rel="noopener noreferrer"
                />
              }
      ...
      <section className="py-20 bg-[#F8F8F8]">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-gray-500 leading-relaxed">
              Kami menjangkau seluruh wilayah Jabodetabek. Nikmati layanan antar
              gratis khusus untuk pemesanan{" "}
              <span className="font-bold text-[#005926]">minimal 100 box</span>.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 max-w-7xl mx-auto">
            {[
              ...
              },
              {
                ...
                emoji: "🏢",
                areas: ["Kemang", "Kuningan", "SCBD", "Pondok Indah", "Tebet"],
              },
              {
                city: "Jakarta Pusat",
                emoji: "🏛️",
              ...
              },
              {
                city: "Jakarta Utara",
                emoji: "🌊",
                areas: ["Kelapa Gading", "PIK", "Pluit", "Sunter", "Ancol"],
              },
              {
                city: "Jakarta Timur",
                emoji: "🏭",
              ...
              },
              {
                city: "Depok",
                emoji: "🌿",
                areas: ["Margonda", "Cinere", "Sawangan", "Kelapa Dua"],
              },
              {
                city: "Bogor",
                emoji: "⛰️",
                areas: ["Kota Bogor", "Sentul", "Cibinong", "Baranangsiang"],
              },
              {
                city: "Bekasi",
                emoji: "🏬",
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-4 pt-2">
                  ...
                  <Link
                    href={`/nasi-box/${slugify(region.city)}`}
                    className="font-heading font-bold text-base text-[#1a1a1a] hover:text-[#005926] transition-colors"
                  >
                    {region.city}
                  </Link>
                </div>
                ...
                <ul className="space-y-2 flex-1">
                  {region.areas.map((area, i) => (
                    <li key={i}>
                      <Link
                        href={`/nasi-box/${slugify(area)}`}
                        className="flex items-center gap-2 text-xs text-gray-600 hover:text-[#005926] hover:font-medium transition-colors"
                      >
          ...
          <div className="mt-10 max-w-3xl mx-auto bg-white border border-[#005926]/15 rounded-2xl p-6 flex flex-col sm:flex-row items-center gap-5 shadow-sm">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-sm text-gray-500">
                *Gratis ongkir berlaku untuk minimum pemesanan 100 box. Hubungi
                admin kami untuk konfirmasi jangkauan lokasi Anda.
              </p>
            </div>
            <Button
              render={
                <a
                  href="https://wa.me/62895328596248?text=Halo%20Admin%20Dapur%20Srasa%2C%20saya%20ingin%20bertanya%20apakah%20area%20%5BNAMA%20AREA%5D%20masuk%20jangkauan%20pengiriman%20Nasi%20Box%3F"
                  target="_blank"
                  rel="noopener noreferrer"
                />
              }
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 max-w-5xl mx-auto">
            ...
            <div className="text-white text-center lg:text-left">
              ...
              <p className="text-white/70 text-base mb-4 leading-relaxed max-w-md mx-auto lg:mx-0">
                Dapatkan daftar lengkap 17 menu nasi box Dapur Srasa dalam
                format gambar yang siap dibagikan. Cocok untuk referensi
                pemesanan atau dikirim ke rekan Anda.
              </p>
              <ul className="flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-2 text-sm text-white/70 mb-8">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#D4AF37]" /> 17 Pilihan
                  Menu
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#D4AF37]" /> Info Harga
                  Lengkap
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#D4AF37]" /> Kualitas
                  Gambar Tinggi
                </li>
              </ul>
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                <Button
                  render={
                    <a
                      href="/katalog-nasi-box.jpg"
                      download="Katalog-Nasi-Box-Dapur-Srasa.jpg"
                    />
                  }
                ...
                <Button
                  render={
                    <a
                      href="https://wa.me/62895328596248?text=Halo%20Admin%20Srasa,%20saya%20mau%20pesan%20Nasi%20Box.%20Boleh%20minta%20katalog%20menu%3F"
                      target="_blank"
                      rel="noopener noreferrer"
                    />
                  }
