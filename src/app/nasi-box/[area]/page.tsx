      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `Nasi Box Dapur Srasa di ${areaName}`,
        },
      ],
    },
    twitter: {
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Nasi Box Premium di {areaName} <br /> Mulai{" "}
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mb-14">
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-[#333333] mb-4">
              Pilihan Menu Nasi Box untuk {areaName}
            </h2>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center">
            <Button
              render={
                <a
                  href={`https://wa.me/62895328596248?text=Halo%20Admin%20Srasa,%20saya%20di%20${areaName}%20mau%20pesan%20Nasi%20Box.%20Boleh%20minta%20info%20lebih%20lanjut%3F`}
                  target="_blank"
                  rel="noopener noreferrer"
                />
              }
      ...
      <section className="py-20 bg-[#F8F8F8]">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-gray-500 leading-relaxed">
              Kami menjangkau seluruh wilayah Jabodetabek, termasuk {areaName}.
              Nikmati layanan antar gratis khusus untuk pemesanan{" "}
